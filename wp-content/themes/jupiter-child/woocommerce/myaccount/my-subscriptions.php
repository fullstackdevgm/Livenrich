...
<div class="woocommerce_account_subscriptions">
	...
	<?php foreach ( $subscriptions as $subscription_id => $subscription ) : ?>
		<tr class="order">
			<td class="subscription-id order-numberrrr" data-title="<?php esc_attr_e( 'ID', 'woocommerce-subscriptions' ); ?>">
				<a href="<?php echo get_site_url(); ?>/account-page/?uap_aff_subtab=view_sub&view-subscription=<?php echo  $subscription->get_order_number();?>"><?php echo esc_html( sprintf( _x( '#%s', 'hash before order number', 'woocommerce-subscriptions' ), $subscription->get_order_number() ) ); ?></a>
