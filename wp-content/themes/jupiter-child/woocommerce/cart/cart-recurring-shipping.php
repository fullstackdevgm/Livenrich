...
?>
<li class="shipping recurring-total <?php echo esc_attr( $recurring_cart_key ); ?>">
	<span class="left"><?php echo wp_kses_post( $package_name ); ?></span>
	<span class="right"> data-title="<?php echo esc_attr( $package_name ); ?>">
