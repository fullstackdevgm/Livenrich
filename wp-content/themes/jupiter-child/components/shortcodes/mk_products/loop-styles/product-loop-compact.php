	...
	<div class="mk-product-holder">
		<div class="product-loop-thumb">
			...
			<div class="quantity_select">
				<select name="bundle_quantity[<?php echo $product->get_id(); ?>]" title="Qty" class="qty bundle-qty" id="bundleqty-<?php echo $product->get_id(); ?>">
				<?php
					$i = 1;
			        while ($i <= $max_value) {
			            echo sprintf('<option value="%s">%s%s</option>', $i, $i, __("套", 'woocommerce'));
			            $i++;
			        }
				?>
				</select>
