    ...
    "params" => array(
        ...
        array(
            ...
            "value" => array(
                ...
                __("5 columns", 'mk_framework') => "5",
                __("6 columns", 'mk_framework') => "6",
                __("7 columns", 'mk_framework') => "7",
        ...
        array(
            ...
            "description" => __("Sort retrieved product items by parameter.", 'mk_framework'),
            "param_name" => "orderby",
            "value" => $mk_orderby,
            "type" => "dropdown",
            "dependency" => array(
