...
<div class="wcsatt-options <?php echo esc_attr( $classes ); ?>">
<select name="convert_to_sub_<?php echo absint( $product_id ); ?>">
	<?phpforeach ( $options as $option_id => $option ) {
			?>
					<option value="<?php echo $option_id ?>" <?php selected( $option[ 'selected' ], true, true ); ?>><?php echo wp_kses_post( $option[ 'description' ] ); ?></option>
