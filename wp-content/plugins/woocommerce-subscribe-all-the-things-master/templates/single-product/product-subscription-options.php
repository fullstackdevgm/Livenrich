...
<div class="wcsatt-options-wrapper" <?php echo count( $options ) === 1 ? 'style="display:none;"' : '' ?>><?php
	...
	?></ul>-->
	<select name="convert_to_sub_<?php echo absint( $product_id ); ?>" style="margin: 0 auto !important;">
	<?php foreach ( $options as $option ) {
			?>
					<option value="<?php echo esc_attr( $option[ 'value' ] ); ?>" <?php selected( $option[ 'selected' ], true, true ); ?>><?php echo $option[ 'description' ]; ?></option>
