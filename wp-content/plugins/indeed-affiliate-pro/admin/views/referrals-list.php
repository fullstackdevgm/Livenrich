<div class="uap-wrapper">
	<div class="uap-page-title">Ultimate Affiliate Pro - <span class="second-text"><?php _e('Referrals', 'uap');?></span></div>
		...
		<span class="uap-top-message"><?php _e('...add manual Referrals for specific Affiliate', 'uap');?></span>
						...
						<tbody class="ui-sortable uap-alternate">
							<?php foreach ($data['listing_items'] as $array) : ?>
								<tr onmouseover="uap_dh_selector('.hidden-div-referral-<?php echo $array['id'];?>', 1);" onmouseout="uap_dh_selector('.hidden-div-referral-<?php echo $array['id'];?>', 0);">
									...
									<td style="color: #396;"><?php  echo date("F d,Y", strtotime($array['date']));//echo uap_convert_date_to_us_format($array['date']);?></td>
									<td><?php 
											/*
											 * 1 - UNVERIFIED
											 * 2 - VERIFIED
