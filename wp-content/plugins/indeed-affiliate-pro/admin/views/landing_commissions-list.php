<div class="uap-wrapper">
	<div class="uap-page-title">Ultimate Affiliate Pro - <span class="second-text"><?php _e('Landing Commissions', 'uap');?></span></div>
		<a href="<?php echo $data['url-add_edit'];?>" class="uap-add-new-like-wp"><i class="fa-uap fa-add-uap"></i><span><?php _e('Add New Landing Commission', 'uap');?></span></a>
		<span class="uap-top-message"><?php _e('...create your Landing Commission Shortcode', 'uap');?></span>
		...
		<?php if (!empty($data['listing_items'])) : ?>
			<form action="" method="post" id="form_shortcodes">
				...
				<div class="uap-info-box"><?php _e('Just copy the landing commission shortcode into any successful page (ex: Thank You Register page) and the affiliate will receive a certain commission based on generated referral.', 'uap');?></div>
