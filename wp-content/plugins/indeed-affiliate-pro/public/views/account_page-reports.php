...
<?php if (!empty($data['total_paid'])): ?>
		<div class="uapcol-md-3">
			<div class="uap-account-no-box uap-account-box-green">
			  <div class="uap-account-no-box-inside">
				<div class="uap-count"><?php echo uap_format_price_and_currency($data['currency'], round($data['total_paid'], 2));?></div><div class="uap-detail"><?php echo __('Total Earnings (paid Refferals)', 'uap'); ?></div>
			  </div>
			</div>
		</div>
<?php endif;?>
