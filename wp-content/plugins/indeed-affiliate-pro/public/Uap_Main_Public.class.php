	...
	class Uap_Main_Public{
		...
		public function affiliate_print_register_form($attr=array()){
			...
			if ($this->is_admin){
				...
				ob_start();
				$data['action'] = '';
				require UAP_PATH . 'public/views/register.php';
		...
		private function print_trial_message(){
			 ...
			 */
			ob_start();
			require UAP_PATH . 'public/views/trial_version_message.php';
			$output = ob_get_contents();
			ob_end_clean();
			return $output;
		}
		...
		public function affiliate_print_logout($attr=array()){
			...
			if ($this->user_id){ // && $this->affiliate_id
				...
				ob_start();
				require UAP_PATH . 'public/views/logout.php';
				$output = ob_get_contents();
				ob_end_clean();
			}
			return $output;
		...
		public function return_admin_info_message($type=''){
			 ...
			 */
			 ...
			 ob_start();
			 require UAP_PATH . 'public/views/message_for_admin.php';
			 $output = ob_get_contents();
			 ob_end_clean();
			 return $output;
		}
		...
		public function affiliate_print_become_affiliate_bttn(){
			 ...
			 */
			 ...
			 if ($this->user_id && !$indeed_db->is_user_affiliate_by_uid($this->user_id)){
				ob_start();
			 	require_once UAP_PATH . 'public/views/become_affiliate_bttn.php';
			 	$output = ob_get_contents();
			 	ob_end_clean();
			 	return $output;
			 }
